...
test_sample_extractor = True
if test_sample_extractor:
    # define a random sample extractor object for the first 3D volume
    random_sample_extractor = SampleExtractor((512,512), vol_batch[0], seg_batch[0], labeling='neither', max_rotation=0, gaussian_blur=False, elastic_deformation=False)
...
nr_validation_samples_per_3D_volume = 10
