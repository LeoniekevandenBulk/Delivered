...
train_batch_1_dir='./Training_Batch_1'

vol_batch_1 = sorted(get_file_list(train_batch_1_dir, 'volume')[0])
seg_batch_1 = sorted(get_file_list(train_batch_1_dir, 'segmentation')[0])

#for i, (vol, seg) in enumerate(zip(vol_batch_1, seg_batch_1)):
...
n_validation_images = int(ceil(len(vol_batch_1)*validation_percentage))

# use the first images as validation
val_vol_batch_1 = vol_batch_1[0:n_validation_images]
val_seg_batch_1 = seg_batch_1[0:n_validation_images]

# the rest as training
tra_vol_batch_1 = vol_batch_1[n_validation_images:]
tra_seg_batch_1 = seg_batch_1[n_validation_images:]

print("nr of training images: " + str(len(tra_vol_batch_1)) + "\nnr of validation images: " + str(len(val_vol_batch_1)))
...
random_sample_extractor = SampleExtractor((512,512), tra_vol_batch_1[0], tra_seg_batch_1[0], max_rotation=0, rnd_flipping=False)
...
sample_ex_train = SampleExtractor(patch_size, tra_vol_batch_1[0], tra_seg_batch_1[0], max_rotation=max_rotation, rnd_flipping=flipping)
