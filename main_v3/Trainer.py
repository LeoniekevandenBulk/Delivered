...
class Trainer:
    ...
    def trainNetwork(self, start_time, network_name, mask,
        ...
        for epoch in range(nr_epochs):
            ...
            for batch in range(nr_train_batches):
                ...
                prediction, loss, accuracy = self.train_batch(network, X_tra, Y_tra, M_tra, weight_balance, target_class)
            ...
            for batch in range(nr_val_batches):
                ...
                prediction, loss, accuracy = self.validate_batch(network, X_val, Y_val, M_val, weight_balance, target_class)
                prediction = prediction.reshape(batch_size, 1, out_size[0], out_size[1], 2)[:, :, :, :, 1]
    ...
    '''
    def train_batch(self, network, X_tra, Y_tra, M_tra, weight_balance, target_class):
    ...
    '''
        ...
        Returns the generated heatmaps to use for evaluation
    '''
    def validate_batch(self, network, X_val, Y_val, M_val, weight_balance, target_class):
